    ...
    <div>
        <div v-if="tp==0">
            <ul class="nav nav-tabs">
                ...
                <li v-if="ibook>0" v-bind:class="{active:itab==2}" v-on:click="clicktab(2)"><a href="#">{{books[ibook-1][2]}}<span v-if="ichap>0">{{ichap}}</span></a></li>
            </ul>
            <div v-if="itab==0">
            ...
            <div v-if="itab==1 && ibook>0">
                <span v-for="a1 in cntchaps[ibook-1]" v-on:click="clickchap(a1)" class="btn" v-bind:class="{beSelected:a1==ichap-1}">{{a1}} </span>
            </div>
        </div>
        <div v-if="tp==1">
            <div>
